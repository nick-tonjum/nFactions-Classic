...
execute as @a at @s store result score @s yposf run data get entity @s Pos[1] 1
execute as @a[scores={yposf=245..}] run tellraw @s {"text":"You've reached the height limit of this world!","color":"red"}
execute as @a[scores={yposf=245..}] at @s run tp ~ ~-0.5 ~
